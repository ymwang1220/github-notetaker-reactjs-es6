...
/***/ function(module, exports, __webpack_require__) {
	...
	var base = _reBase2['default'].createClass('https://amber-heat-7692.firebaseio.com/');
	    ...
	    _createClass(AddNote, [{
	        ...
	        value: function render() {
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement('input', { type: 'text', className: 'form-control', ref: 'note', placehold: 'Add New Note' }),
	                _react2['default'].createElement(
	                    'span',
